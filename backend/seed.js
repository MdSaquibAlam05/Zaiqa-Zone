...
// 50 dishes array (tumhari existing dishes wahi rahegi)
const dishes = [
  { name: "Butter Chicken", description: "Creamy tomato-based chicken curry", price: 350, category: "North Indian", type: "non-veg", restaurant: "Punjab Grill", rating: 4.5, prepTime: "25 min", isPopular: true, image: "https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=800&q=80" },
  { name: "Dal Makhani", description: "Slow-cooked black lentils", price: 220, category: "North Indian", type: "veg", restaurant: "Punjab Grill", rating: 4.3, prepTime: "30 min", image: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800&q=80" },
  { name: "Paneer Tikka", description: "Charcoal-grilled cottage cheese", price: 280, category: "North Indian", type: "veg", restaurant: "Punjab Grill", rating: 4.6, prepTime: "20 min", isPopular: true, image: "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=800&q=80" },
  { name: "Chicken Biryani", description: "Fragrant basmati rice with chicken", price: 320, category: "North Indian", type: "non-veg", restaurant: "Biryani House", rating: 4.7, prepTime: "35 min", isPopular: true, image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=800&q=80" },
  { name: "Masala Dosa", description: "Crispy rice crepe with potato", price: 180, category: "South Indian", type: "veg", restaurant: "Sagar Ratna", rating: 4.6, prepTime: "15 min", isPopular: true, image: "https://images.unsplash.com/photo-1630383249896-424e482df921?w=800&q=80" },
  { name: "Margherita Pizza", description: "Classic cheese pizza", price: 250, category: "Italian", type: "veg", restaurant: "Domino's", rating: 4.4, prepTime: "20 min", isPopular: true, image: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=800&q=80" },
  { name: "Chole Bhature", description: "Spicy chickpea curry", price: 150, category: "North Indian", type: "veg", restaurant: "Haldiram's", rating: 4.5, prepTime: "20 min", isPopular: true, image: "https://images.unsplash.com/photo-1626132647523-66f5bf380027?w=800&q=80" },
  { name: "Gulab Jamun", description: "Soft milk dumplings in syrup", price: 120, category: "Desserts", type: "veg", restaurant: "Haldiram's", rating: 4.7, prepTime: "10 min", isPopular: true, image: "https://images.unsplash.com/photo-1666190050264-0a5fb3ea3494?w=800&q=80" },
  { name: "Cheese Burger", description: "Grilled patty with cheese", price: 180, category: "Fast Food", type: "veg", restaurant: "Burger King", rating: 4.2, prepTime: "15 min", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80" },
  { name: "Chicken Whopper", description: "Flame-grilled chicken", price: 220, category: "Fast Food", type: "non-veg", restaurant: "Burger King", rating: 4.4, prepTime: "18 min", isPopular: true, image: "https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=800&q=80" }
];
...
const seedDB = async () => {
  try {
    ...
    console.log('\n🎉 SEED COMPLETE!');
    console.log(`📊 ${dishes.length} Dishes + 1 Admin\n`);
